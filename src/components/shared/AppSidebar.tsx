...
const adminNavItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: <WebIcon />,
    subItems: [
      { name: "Registered Users", path: APP_PATHS.wordPressUsers },
      { name: "Contact Leads", path: APP_PATHS.contactLeads },
    ],
  },
];
      ...
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
            ...
            // When collapsed
            <img
              src="/images/logo/Census-travel-icon-transparent.png"
              alt="Logo"
              width={42}
              height={42}
            />
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              {renderMenuItems(
                userInfo?.role === "admin" ? adminNavItems : affiliateNavItems,
                "main",
              )}
            </div>
          </div>
